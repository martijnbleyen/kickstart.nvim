    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('<leader>k', vim.lsp.buf.code_action, 'Open code actions', { 'n', 'x' })
        ...
        content = {
          active = function()
            ...
            local function fileinfo_with_icon()
              ...
              local type_label = filetype ~= '' and filetype or 'no ft'

              return string.format('%s %s', icon or '', type_label)
            end

            local fileinfo = fileinfo_with_icon()
